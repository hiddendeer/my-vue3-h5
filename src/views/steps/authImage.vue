<template>
  <div v-if="authType == '0'">
    <div class="row" style="background-color: #fafafa">
      <div class="col-md-4 col-xs-12 flex justify-end" style="margin-right: 10px; flex: 1">
        <el-upload
          :headers="headers"
          :data="data1"
          name="fileImage"
    ...
    <div class="row" style="background-color: #fafafa; margin-top: 10px">
      ...
      <div class="col-md-4 col-xs-12" style="margin-right: 10px; flex: 1"></div>
    </div>
  </div>
  <div v-if="authType == '1'">
    <div class="row" style="background-color: #fafafa">
...
import imageUrl4 from "/image/img/cardimg_fc.png";
